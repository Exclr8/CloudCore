...
namespace CloudCore.Web.Core.Controls.Grid.Wrappers
{
	/// <summary>
	...
	public static class GridExtensions
	{
		...
		/// <returns></returns>
        public static IGrid<T> Grid<T>(this HtmlHelper helper, IQueryable<T> dataSource) where T : class
		{
		...
		public static IGrid<T> Grid<T>(this HtmlHelper helper, string viewDataKey) where T : class
		{
			...
			return helper.Grid(dataSource.AsQueryable());
		}
