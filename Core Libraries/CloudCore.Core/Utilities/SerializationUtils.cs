    ...
    public static class Serialization
    {
        ...
        public static bool SerializeObject(object instance, string fileName, bool binarySerialization)
        {
            ...
            if (!binarySerialization)
            {
                ...
                {
                    Debug.Write("SerializeObject failed with : " + ex.Message, "Exclr8");
                    retVal = false;
                }
                finally
                {
        ...
        public static bool SerializeObject(object instance, out byte[] resultBuffer, bool throwExceptions = false)
        {
            ...
            {
                Debug.Write("SerializeObject failed with : " + ex.GetBaseException().Message, "Exclr8");
                retVal = false;
        ...
        public static string SerializeObjectToJson(object instance)
        {
            return JsonConvert.SerializeObject(instance);
        }

        public static Expando DeSerializeJsonToObject(string json)
        {
            return JsonConvert.DeserializeObject<Expando>(json);
        }
