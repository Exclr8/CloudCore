...
using FrameworkOne.CloudCoreCodeGenerator;

namespace CloudCoreCodeGenerator_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new CloudCoreCodeGeneratorPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(FrameworkOne.CloudCoreCodeGenerator.GuidList.guidCloudCoreCodeGeneratorCmdSet, (int)FrameworkOne.CloudCoreCodeGenerator.PkgCmdIDList.cmdidCodeGenerator);
