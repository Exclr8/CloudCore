...
namespace Architect
{
	...
	/// <summary>
	/// Double-derived template directive processor that provides CloudCoreArchitectSubProcess files
	/// The implementation is done in CloudCoreArchitectSubProcessDirectiveProcessorBase. This class
	/// exist so users can customize behavior easily.
	/// </summary>
	public sealed partial class CloudCoreArchitectSubProcessDirectiveProcessor : CloudCoreArchitectSubProcessDirectiveProcessorBase
	{
		/// <summary>
		/// Constructor
		/// </summary>
		public CloudCoreArchitectSubProcessDirectiveProcessor()
			: base()
		{
		}
	}
	...
	/// <summary>
	/// Base implementation for template directive processor that provides CloudCoreArchitectSubProcess files
	/// </summary>
	public class CloudCoreArchitectSubProcessDirectiveProcessorBase : VSTextTemplating::RequiresProvidesDirectiveProcessor
	{
		/// <summary>
		/// The friendly name of this processor.
		/// </summary>
		public const string CloudCoreArchitectSubProcessDirectiveProcessorName = "CloudCoreArchitectSubProcessDirectiveProcessor";
		...
		/// </summary>
		private const string providesModelParameter = "SubProcess";
		...
		/// </summary>
		private const string supportedDirectiveName = "CloudCoreArchitectSubProcess";
		...
		/// Constructor
		/// </summary>
		public CloudCoreArchitectSubProcessDirectiveProcessorBase()
			: base()
		{
		}
		...
		protected override string FriendlyName
		{
			get
			{
				return CloudCoreArchitectSubProcessDirectiveProcessorName;
			}
		}
		...
		protected override void GenerateTransformCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				if (languageProvider != null)
				{
					...
					rootElement.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::Architect.SubProcess));
					...
					rootElementProperty.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::Architect.SubProcess));
					...
					if (!this.oneTimeCodeGenerated && global::System.IO.File.Exists(this.Host.TemplateFile))
					{
						...
						resolver.Name = "Convert" + "SubProcess" + "RelativePathToTemplateRelativePath";
		...
		protected override void GeneratePreInitializationCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				...
				{
					string[] domainModels = {
						"Architect.CloudCoreArchitectSubProcessDomainModel",
					};
				...
				if (languageProvider != null)
				{
					...
					if(LoadDiagramData)
					{
						...
						invokeEnableDiagramRules = new global::System.CodeDom.CodeMethodInvokeExpression(
							new global::System.CodeDom.CodeMethodReferenceExpression(new global::System.CodeDom.CodeTypeReferenceExpression("CloudCoreArchitectSubProcessDomainModel"), "EnableDiagramRules"), new global::System.CodeDom.CodePropertyReferenceExpression(new global::System.CodeDom.CodeThisReferenceExpression(), "Store"));
