...
namespace Architect
{
	...
	/// </remarks>
	public partial class CloudCoreArchitectSubProcessHelpKeywordHelper : CloudCoreArchitectSubProcessHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new CloudCoreArchitectSubProcessHelpKeywordHelper.
		/// </summary>
		protected CloudCoreArchitectSubProcessHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the CloudCoreArchitectSubProcessHelpKeywordHelper.
		/// </summary>
		public static CloudCoreArchitectSubProcessHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class CloudCoreArchitectSubProcessHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new CloudCoreArchitectSubProcessHelpKeywordHelperBase.
		/// </summary>
		protected CloudCoreArchitectSubProcessHelpKeywordHelperBase()
			: base() { }
