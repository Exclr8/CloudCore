...
namespace Architect.ProcessOverview
{
	...
	/// <summary>
	/// Double-derived template directive processor that provides CloudCoreArchitectProcessOverview files
	/// The implementation is done in CloudCoreArchitectProcessOverviewDirectiveProcessorBase. This class
	/// exist so users can customize behavior easily.
	/// </summary>
	public sealed partial class CloudCoreArchitectProcessOverviewDirectiveProcessor : CloudCoreArchitectProcessOverviewDirectiveProcessorBase
	{
		/// <summary>
		/// Constructor
		/// </summary>
		public CloudCoreArchitectProcessOverviewDirectiveProcessor()
			: base()
		{
		}
	}
	...
	/// <summary>
	/// Base implementation for template directive processor that provides CloudCoreArchitectProcessOverview files
	/// </summary>
	public class CloudCoreArchitectProcessOverviewDirectiveProcessorBase : VSTextTemplating::RequiresProvidesDirectiveProcessor
	{
		/// <summary>
		/// The friendly name of this processor.
		/// </summary>
		public const string CloudCoreArchitectProcessOverviewDirectiveProcessorName = "CloudCoreArchitectProcessOverviewDirectiveProcessor";
		...
		/// </summary>
		private const string providesModelParameter = "Process";
		...
		/// </summary>
		private const string supportedDirectiveName = "CloudCoreArchitectProcessOverview";
		...
		/// Constructor
		/// </summary>
		public CloudCoreArchitectProcessOverviewDirectiveProcessorBase()
			: base()
		{
		}
		...
		protected override string FriendlyName
		{
			get
			{
				return CloudCoreArchitectProcessOverviewDirectiveProcessorName;
			}
		}
		...
		protected override void GenerateTransformCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				if (languageProvider != null)
				{
					...
					rootElement.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::Architect.ProcessOverview.Process));
					...
					rootElementProperty.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::Architect.ProcessOverview.Process));
					...
					if (!this.oneTimeCodeGenerated && global::System.IO.File.Exists(this.Host.TemplateFile))
					{
						...
						resolver.Name = "Convert" + "Process" + "RelativePathToTemplateRelativePath";
		...
		protected override void GeneratePreInitializationCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				...
				{
					string[] domainModels = {
						"Architect.ProcessOverview.CloudCoreArchitectProcessOverviewDomainModel",
					};
				...
				if (languageProvider != null)
				{
					...
					if(LoadDiagramData)
					{
						...
						invokeEnableDiagramRules = new global::System.CodeDom.CodeMethodInvokeExpression(
							new global::System.CodeDom.CodeMethodReferenceExpression(new global::System.CodeDom.CodeTypeReferenceExpression("CloudCoreArchitectProcessOverviewDomainModel"), "EnableDiagramRules"), new global::System.CodeDom.CodePropertyReferenceExpression(new global::System.CodeDom.CodeThisReferenceExpression(), "Store"));
		...
		public override string[] GetImportsForProcessingRun()
		{
			...
			imports.Add("Architect.ProcessOverview");
