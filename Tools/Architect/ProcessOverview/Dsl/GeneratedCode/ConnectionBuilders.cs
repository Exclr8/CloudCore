...
namespace Architect.ProcessOverview
{
	...
	/// </summary>
	public static partial class SubProcessElementReferencesTargetsBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::Architect.ProcessOverview.SubProcessElement)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::Architect.ProcessOverview.SubProcessElement)
				{
					if (candidateTarget is global::Architect.ProcessOverview.SubProcessElement)
					{
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::Architect.ProcessOverview.SubProcessElement)
				{
					if (target is global::Architect.ProcessOverview.SubProcessElement)
					{
						global::Architect.ProcessOverview.SubProcessElement sourceAccepted = (global::Architect.ProcessOverview.SubProcessElement)source;
						global::Architect.ProcessOverview.SubProcessElement targetAccepted = (global::Architect.ProcessOverview.SubProcessElement)target;
						DslModeling::ElementLink result = new global::Architect.ProcessOverview.SubProcessElementReferencesTargets(sourceAccepted, targetAccepted);
