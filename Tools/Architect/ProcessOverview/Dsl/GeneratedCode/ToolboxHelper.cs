...
namespace Architect.ProcessOverview
{
	...
	/// </remarks>
	public partial class CloudCoreArchitectProcessOverviewToolboxHelper : CloudCoreArchitectProcessOverviewToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new CloudCoreArchitectProcessOverviewToolboxHelper.
		/// </summary>
		public CloudCoreArchitectProcessOverviewToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class CloudCoreArchitectProcessOverviewToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify CloudCoreArchitectProcessOverview toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "CloudCoreArchitectProcessOverview.1.0";
		...
		/// <summary>
		/// Constructs a new CloudCoreArchitectProcessOverviewToolboxHelperBase.
		/// </summary>
		protected CloudCoreArchitectProcessOverviewToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Architect.ProcessOverview.CloudCoreArchitectProcessOverviewDomainModel.SingletonResourceManager.GetString("ProcessOverviewToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::Architect.ProcessOverview.CloudCoreArchitectProcessOverviewDomainModel.SingletonResourceManager;
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Architect.ProcessOverview.CloudCoreArchitectProcessOverviewDomainModel));
