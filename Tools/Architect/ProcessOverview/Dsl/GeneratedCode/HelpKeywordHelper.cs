...
namespace Architect.ProcessOverview
{
	...
	/// </remarks>
	public partial class CloudCoreArchitectProcessOverviewHelpKeywordHelper : CloudCoreArchitectProcessOverviewHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new CloudCoreArchitectProcessOverviewHelpKeywordHelper.
		/// </summary>
		protected CloudCoreArchitectProcessOverviewHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the CloudCoreArchitectProcessOverviewHelpKeywordHelper.
		/// </summary>
		public static CloudCoreArchitectProcessOverviewHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class CloudCoreArchitectProcessOverviewHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new CloudCoreArchitectProcessOverviewHelpKeywordHelperBase.
		/// </summary>
		protected CloudCoreArchitectProcessOverviewHelpKeywordHelperBase()
			: base() { }
