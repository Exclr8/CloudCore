...
namespace Architect.ProcessOverview
{
	...
	/// </summary>
	internal partial class CloudCoreArchitectProcessOverviewDocData : CloudCoreArchitectProcessOverviewDocDataBase
	{
		/// <summary>
		/// Constructs a new CloudCoreArchitectProcessOverviewDocData.
		/// </summary>
		public CloudCoreArchitectProcessOverviewDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a CloudCoreArchitectProcessOverview document in memory.
	/// </summary>
	internal abstract partial class CloudCoreArchitectProcessOverviewDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new CloudCoreArchitectProcessOverviewDocDataBase.
		/// </summary>
		protected CloudCoreArchitectProcessOverviewDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::Architect.ProcessOverview.CloudCoreArchitectProcessOverviewDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::Architect.ProcessOverview.CloudCoreArchitectProcessOverviewDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::Architect.ProcessOverview.CloudCoreArchitectProcessOverviewDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::Architect.ProcessOverview.CloudCoreArchitectProcessOverviewDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::Architect.ProcessOverview.Process modelRoot = null;
			...
			global::Architect.ProcessOverview.CloudCoreArchitectProcessOverviewDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::Architect.ProcessOverview.CloudCoreArchitectProcessOverviewSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::Architect.ProcessOverview.CloudCoreArchitectProcessOverviewDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::Architect.ProcessOverview.CloudCoreArchitectProcessOverviewDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::Architect.ProcessOverview.Process modelRoot = (global::Architect.ProcessOverview.Process)this.RootElement;
			...
			{
				global::Architect.ProcessOverview.ProcessOverviewDiagram diagram = diagrams[0] as global::Architect.ProcessOverview.ProcessOverviewDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::Architect.ProcessOverview.CloudCoreArchitectProcessOverviewSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::Architect.ProcessOverview.CloudCoreArchitectProcessOverviewSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::Architect.ProcessOverview.CloudCoreArchitectProcessOverviewDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::Architect.ProcessOverview.CloudCoreArchitectProcessOverviewSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::Architect.ProcessOverview.Process modelRoot = this.RootElement as global::Architect.ProcessOverview.Process;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::Architect.ProcessOverview.CloudCoreArchitectProcessOverviewSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
