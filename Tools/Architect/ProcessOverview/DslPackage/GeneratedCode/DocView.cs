...
namespace Architect.ProcessOverview
{
	...
	/// </summary>
	internal partial class CloudCoreArchitectProcessOverviewDocView : CloudCoreArchitectProcessOverviewDocViewBase
	{
		/// <summary>
		/// Constructs a new CloudCoreArchitectProcessOverviewDocView.
		/// </summary>
		public CloudCoreArchitectProcessOverviewDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class CloudCoreArchitectProcessOverviewDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new CloudCoreArchitectProcessOverviewDocView.
		/// </summary>
		...
		protected override bool LoadView()
		{
			...
			CloudCoreArchitectProcessOverviewDocDataBase docData = this.DocData as CloudCoreArchitectProcessOverviewDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for CloudCoreArchitectProcessOverviewDocViewBase should be an CloudCoreArchitectProcessOverviewDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Architect.ProcessOverview.ProcessOverviewDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Architect.ProcessOverview.ProcessOverviewDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Architect.ProcessOverview.CloudCoreArchitectProcessOverviewToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Architect.ProcessOverview.CloudCoreArchitectProcessOverviewToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.CloudCoreArchitectProcessOverviewDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Architect.ProcessOverview.CloudCoreArchitectProcessOverviewHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Architect.ProcessOverview.CloudCoreArchitectProcessOverviewHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Architect.ProcessOverview.CloudCoreArchitectProcessOverviewHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
