...
{
    /// <summary>
    /// Adapter manager base class (double derived pattern) for the CloudCoreArchitectProcessOverview Designer
    /// </summary>
    public partial class CloudCoreArchitectProcessOverviewAdapterManagerBase : DslIntegrationShell::VsModelingAdapterManager
    {
        #region Fields
        /// <summary>
        ...
        public CloudCoreArchitectProcessOverviewAdapterManagerBase()
        {
        }
        #endregion
        ...
        public override global::System.Collections.Generic.IEnumerable<string> GetSupportedLogicalAdapterIds()
        {
            if (supportedAdapterIds == null)
            {
                ...
                supportedAdapterIds = new string[] { CloudCoreArchitectProcessOverviewAdapter.AdapterId };
            }
        ...
        public override DslIntegration::ModelBusReference CreateReference(params object[] modelLocatorInfo)
        {
            ...
            DslIntegration::ModelBusReference mbr = new DslIntegration::ModelBusReference(
                this.ModelBus, CloudCoreArchitectProcessOverviewAdapter.AdapterId,
    ...
    /// <summary>
    /// ModelBus modeling adapter manager for a CloudCoreArchitectProcessOverviewAdapter model adapter
    /// </summary>
    [Mef::Export(typeof(DslIntegration::ModelBusAdapterManager))]
    [Mef::ExportMetadata(DslIntegration::CompositionAttributes.AdapterIdKey,CloudCoreArchitectProcessOverviewAdapter.AdapterId)]
    [DslIntegration::HostSpecific(DslIntegrationShell::VsModelingAdapterManager.HostName)]
    public partial class CloudCoreArchitectProcessOverviewAdapterManager : CloudCoreArchitectProcessOverviewAdapterManagerBase
    {
    }
}
