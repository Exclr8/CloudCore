...
namespace Architect
{
	...
	/// </summary>
	internal partial class CloudCoreArchitectSubProcessDocView : CloudCoreArchitectSubProcessDocViewBase
	{
		/// <summary>
	...
	/// </summary>
	internal abstract class CloudCoreArchitectSubProcessDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new CloudCoreArchitectSubProcessDocView.
		/// </summary>
		protected CloudCoreArchitectSubProcessDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			CloudCoreArchitectSubProcessDocDataBase docData = this.DocData as CloudCoreArchitectSubProcessDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for CloudCoreArchitectSubProcessDocViewBase should be an CloudCoreArchitectSubProcessDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Architect.SubProcessDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Architect.SubProcessDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Architect.CloudCoreArchitectSubProcessToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Architect.CloudCoreArchitectSubProcessToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.CloudCoreArchitectSubProcessDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Architect.CloudCoreArchitectSubProcessHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Architect.CloudCoreArchitectSubProcessHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Architect.CloudCoreArchitectSubProcessHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
