...
namespace Architect
{
	...
	/// </summary>
	internal partial class CloudCoreArchitectSubProcessDocData : CloudCoreArchitectSubProcessDocDataBase
	{
		/// <summary>
		/// Constructs a new CloudCoreArchitectSubProcessDocData.
		/// </summary>
		public CloudCoreArchitectSubProcessDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a CloudCoreArchitectSubProcess document in memory.
	/// </summary>
	internal abstract partial class CloudCoreArchitectSubProcessDocDataBase : DslShell::ModelingDocData
	{
		...
		/// <summary>
		/// Constructs a new CloudCoreArchitectSubProcessDocDataBase.
		/// </summary>
		protected CloudCoreArchitectSubProcessDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::Architect.CloudCoreArchitectSubProcessDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::Architect.CloudCoreArchitectSubProcessDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::Architect.CloudCoreArchitectSubProcessDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::Architect.CloudCoreArchitectSubProcessDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::Architect.SubProcess modelRoot = null;
			...
			global::Architect.CloudCoreArchitectSubProcessDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::Architect.CloudCoreArchitectSubProcessSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::Architect.CloudCoreArchitectSubProcessDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::Architect.CloudCoreArchitectSubProcessDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		protected override bool CanSave(bool allowUserInterface)
		{
			...
			if (allowUserInterface)
			{
				...
				if (vc.ErrorMessages.Count != 0)
				{
					...
					global::System.Windows.Forms.DialogResult result = DslShell::PackageUtility.ShowMessageBox(this.ServiceProvider, global::Architect.CloudCoreArchitectSubProcessDomainModel.SingletonResourceManager.GetString(errorMsg), VSShellInterop::OLEMSGBUTTON.OLEMSGBUTTON_YESNO, VSShellInterop::OLEMSGDEFBUTTON.OLEMSGDEFBUTTON_SECOND, VSShellInterop::OLEMSGICON.OLEMSGICON_WARNING);
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::Architect.SubProcess modelRoot = (global::Architect.SubProcess)this.RootElement;
			...
			{
				global::Architect.SubProcessDiagram diagram = diagrams[0] as global::Architect.SubProcessDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::Architect.CloudCoreArchitectSubProcessSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::Architect.CloudCoreArchitectSubProcessSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::Architect.CloudCoreArchitectSubProcessDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::Architect.CloudCoreArchitectSubProcessSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::Architect.SubProcess modelRoot = this.RootElement as global::Architect.SubProcess;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::Architect.CloudCoreArchitectSubProcessSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
