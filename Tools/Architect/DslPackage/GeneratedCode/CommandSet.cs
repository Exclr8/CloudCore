...
namespace Architect
{
	...
	/// </summary>
	internal partial class CloudCoreArchitectSubProcessCommandSet : CloudCoreArchitectSubProcessCommandSetBase
	{
		/// <summary>
		/// Constructs a new CloudCoreArchitectSubProcessCommandSet.
		/// </summary>
		public CloudCoreArchitectSubProcessCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class CloudCoreArchitectSubProcessCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new CloudCoreArchitectSubProcessCommandSetBase.
		/// </summary>
		protected CloudCoreArchitectSubProcessCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		{
			if (this.CurrentCloudCoreArchitectSubProcessDocData != null && this.CurrentCloudCoreArchitectSubProcessDocData.Store != null)
			{
				this.CurrentCloudCoreArchitectSubProcessDocData.ValidationController.Validate(this.CurrentCloudCoreArchitectSubProcessDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentCloudCoreArchitectSubProcessDocData != null && this.CurrentCloudCoreArchitectSubProcessDocData.Store != null)
			{
				...
				this.CurrentCloudCoreArchitectSubProcessDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected CloudCoreArchitectSubProcessDocData CurrentCloudCoreArchitectSubProcessDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as CloudCoreArchitectSubProcessDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected CloudCoreArchitectSubProcessDocView CurrentCloudCoreArchitectSubProcessDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as CloudCoreArchitectSubProcessDocView;
			}
		}
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class CloudCoreArchitectSubProcessClipboardCommandSet : CloudCoreArchitectSubProcessClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new CloudCoreArchitectSubProcessClipboardCommandSet.
		/// </summary>
		public CloudCoreArchitectSubProcessClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class CloudCoreArchitectSubProcessClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new CloudCoreArchitectSubProcessClipboardCommandSetBase.
		/// </summary>
		protected CloudCoreArchitectSubProcessClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
