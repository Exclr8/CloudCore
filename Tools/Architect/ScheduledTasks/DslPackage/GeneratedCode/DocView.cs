...
namespace Architect.ScheduledTasks
{
	...
	/// </summary>
	internal partial class ScheduledTasksDocView : ScheduledTasksDocViewBase
	{
		/// <summary>
		/// Constructs a new ScheduledTasksDocView.
		/// </summary>
		public ScheduledTasksDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class ScheduledTasksDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new ScheduledTasksDocView.
		/// </summary>
		...
		protected override bool LoadView()
		{
			...
			ScheduledTasksDocDataBase docData = this.DocData as ScheduledTasksDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for ScheduledTasksDocViewBase should be an ScheduledTasksDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Architect.ScheduledTasks.ScheduledTasksDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Architect.ScheduledTasks.ScheduledTasksDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Architect.ScheduledTasks.ScheduledTasksToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Architect.ScheduledTasks.ScheduledTasksToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.ScheduledTasksDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Architect.ScheduledTasks.ScheduledTasksHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Architect.ScheduledTasks.ScheduledTasksHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Architect.ScheduledTasks.ScheduledTasksHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
