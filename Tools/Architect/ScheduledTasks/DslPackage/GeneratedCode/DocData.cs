...
namespace Architect.ScheduledTasks
{
	...
	/// </summary>
	internal partial class ScheduledTasksDocData : ScheduledTasksDocDataBase
	{
		/// <summary>
		/// Constructs a new ScheduledTasksDocData.
		/// </summary>
		public ScheduledTasksDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a ScheduledTasks document in memory.
	/// </summary>
	internal abstract partial class ScheduledTasksDocDataBase : DslShell::ModelingDocData
	{
		...
		/// <summary>
		/// Constructs a new ScheduledTasksDocDataBase.
		/// </summary>
		protected ScheduledTasksDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::Architect.ScheduledTasks.ScheduledTasksDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::Architect.ScheduledTasks.ScheduledTasksDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::Architect.ScheduledTasks.ScheduledTasksDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::Architect.ScheduledTasks.ScheduledTasksDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::Architect.ScheduledTasks.Group modelRoot = null;
			...
			global::Architect.ScheduledTasks.ScheduledTasksDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::Architect.ScheduledTasks.ScheduledTasksSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, this.ValidationController, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::Architect.ScheduledTasks.ScheduledTasksDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::Architect.ScheduledTasks.ScheduledTasksDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::Architect.ScheduledTasks.Group modelRoot = (global::Architect.ScheduledTasks.Group)this.RootElement;
			...
			{
				global::Architect.ScheduledTasks.ScheduledTasksDiagram diagram = diagrams[0] as global::Architect.ScheduledTasks.ScheduledTasksDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::Architect.ScheduledTasks.ScheduledTasksSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::Architect.ScheduledTasks.ScheduledTasksSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::Architect.ScheduledTasks.ScheduledTasksDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::Architect.ScheduledTasks.ScheduledTasksSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::Architect.ScheduledTasks.Group modelRoot = this.RootElement as global::Architect.ScheduledTasks.Group;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::Architect.ScheduledTasks.ScheduledTasksSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
