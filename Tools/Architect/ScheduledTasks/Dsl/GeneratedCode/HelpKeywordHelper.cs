...
namespace Architect.ScheduledTasks
{
	...
	/// </remarks>
	public partial class ScheduledTasksHelpKeywordHelper : ScheduledTasksHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new ScheduledTasksHelpKeywordHelper.
		/// </summary>
		protected ScheduledTasksHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the ScheduledTasksHelpKeywordHelper.
		/// </summary>
		public static ScheduledTasksHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class ScheduledTasksHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new ScheduledTasksHelpKeywordHelperBase.
		/// </summary>
		protected ScheduledTasksHelpKeywordHelperBase()
			: base() { }
