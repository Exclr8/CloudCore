...
namespace Architect.ScheduledTasks
{
	...
	/// </remarks>
	public partial class ScheduledTasksToolboxHelper : ScheduledTasksToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new ScheduledTasksToolboxHelper.
		/// </summary>
		public ScheduledTasksToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class ScheduledTasksToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify ScheduledTasks toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "ScheduledTasks.1.0";
		...
		/// <summary>
		/// Constructs a new ScheduledTasksToolboxHelperBase.
		/// </summary>
		protected ScheduledTasksToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Architect.ScheduledTasks.ScheduledTasksDomainModel.SingletonResourceManager.GetString("ScheduledTasksToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::Architect.ScheduledTasks.ScheduledTasksDomainModel.SingletonResourceManager;
			global::System.Globalization.CultureInfo resourceCulture = global::System.Globalization.CultureInfo.CurrentUICulture;
			switch(itemId)
			{
				case "Architect.ScheduledTasks.CSharpScheduledTaskToolboxItem":
					// Add CSharpScheduledTask shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Architect.ScheduledTasks.CSharpScheduledTaskToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						1, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("CSharpScheduledTaskToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("CSharpScheduledTaskToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.
						"Architect.ScheduledTasks.ScheduledTasksToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("ScheduledTasksToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"CreateExampleClassF1Keyword", // F1 help keyword for the toolbox item.
						resourceManager.GetString("CSharpScheduledTaskToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::Architect.ScheduledTasks.CSharpScheduledTask.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "Architect.ScheduledTasks.SQLScheduledTaskToolboxItem":
					// Add SQLScheduledTask shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Architect.ScheduledTasks.SQLScheduledTaskToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						2, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("SQLScheduledTaskToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("SQLScheduledTaskToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.
						"Architect.ScheduledTasks.ScheduledTasksToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("ScheduledTasksToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"CreateExampleClassF1Keyword", // F1 help keyword for the toolbox item.
						resourceManager.GetString("SQLScheduledTaskToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::Architect.ScheduledTasks.SqlScheduledTask.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Architect.ScheduledTasks.ScheduledTasksDomainModel));
