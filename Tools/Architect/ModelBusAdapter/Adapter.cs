...
{
   /// <summary>
    /// Modelbus adapter generated class for a CloudCoreArchitectSubProcess model
    /// </summary>
    public partial class CloudCoreArchitectSubProcessAdapterBase : DslIntegration::StandardModelingAdapter, DslIntegration::IModelingAdapterWithStore, DslIntegration::IModelingAdapterWithRootedModel
    {
        // Id of this logical adapter type
        public const string AdapterId = "Architect.CloudCoreArchitectSubProcessAdapter";
        ...
        /// </summary>
        public CloudCoreArchitectSubProcessAdapterBase(DslIntegration::ModelBusReference reference, DslIntegrationShell::VsModelingAdapterManager adapterManager, global::Architect.SubProcess rootModelElement)
        ...
        public global::Architect.SubProcess ModelRoot
        {
            get { return base.AdapterModelRoot as global::Architect.SubProcess; }
        }
    ...
    /// <summary>
    /// Modelbus adapter for a CloudCoreArchitectSubProcess model
    /// </summary>
    public partial class CloudCoreArchitectSubProcessAdapter : CloudCoreArchitectSubProcessAdapterBase
    {
        #region Constructor(s)
        /// <summary>
        /// Constructor from a ModelBusReference, the adapter manager, and the root model element of the CloudCoreArchitectSubProcess model
