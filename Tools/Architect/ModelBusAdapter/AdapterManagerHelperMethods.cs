...
{
    /// <summary>
    /// ModelBus modeling adapter manager for a CloudCoreArchitectSubProcess  model helper methods
    /// </summary>
    public partial class CloudCoreArchitectSubProcessAdapterManager
    {
        ...
        public static DslIntegration::ModelBusReference CreateSubProcess(string modelName, DslIntegration::ModelBusReference relativeTo, string relativePath = null)
        {
            ...
            if (adapter != null)
            {
                ...
                return CreateSubProcess(modelName, filename, relativePath);
            }
            else
                return null;
        }
