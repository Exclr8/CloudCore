...
namespace Architect.ModelBusAdapters
{
    /// <summary>
    /// Adapter manager base class (double derived pattern) for the CloudCoreArchitectSubProcess Designer
    /// </summary>
    public partial class CloudCoreArchitectSubProcessAdapterManagerBase : DslIntegrationShell::VsModelingAdapterManager
    {
        #region Fields
        /// <summary>
        ...
        public CloudCoreArchitectSubProcessAdapterManagerBase()
        {
        }
        #endregion
        ...
        public override global::System.Collections.Generic.IEnumerable<string> GetSupportedLogicalAdapterIds()
        {
            if (supportedAdapterIds == null)
            {
                ...
                supportedAdapterIds = new string[] { CloudCoreArchitectSubProcessAdapter.AdapterId };
            }
            return supportedAdapterIds;
        }

        /// <summary>
        /// Instantiates a ModelBusAdapter for the CloudCoreArchitectSubProcess model of given ModelBusReference and Root Model element
        /// </summary>
        ...
        {
            if (rootModelElement as global::Architect.SubProcess == null) throw new global::System.ArgumentException("Invalid model root passed");
            return new CloudCoreArchitectSubProcessAdapter(reference, this, rootModelElement as global::Architect.SubProcess);
        }
        ...
        public override DslIntegration::ModelBusReference CreateReference(params object[] modelLocatorInfo)
        {
            ...
            DslIntegration::ModelBusReference mbr = new DslIntegration::ModelBusReference(
                this.ModelBus, CloudCoreArchitectSubProcessAdapter.AdapterId,
    ...
    /// <summary>
    /// ModelBus modeling adapter manager for a CloudCoreArchitectSubProcessAdapter model adapter
    /// </summary>
    [Mef::Export(typeof(DslIntegration::ModelBusAdapterManager))]
    [Mef::ExportMetadata(DslIntegration::CompositionAttributes.AdapterIdKey,CloudCoreArchitectSubProcessAdapter.AdapterId)]
    [DslIntegration::HostSpecific(DslIntegrationShell::VsModelingAdapterManager.HostName)]
    public partial class CloudCoreArchitectSubProcessAdapterManager : CloudCoreArchitectSubProcessAdapterManagerBase
    {
    }
}
