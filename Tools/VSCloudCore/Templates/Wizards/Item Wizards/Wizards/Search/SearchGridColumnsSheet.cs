...
{
    public partial class SearchGridColumnsSheet : CloudCore.VSExtension.Controls.Wizard.IntWizardPage
    {
        public SearchGridColumnsSheet()
        {
            InitializeComponent();
        }
        ...
        private void btnAdd_Click(object sender, System.EventArgs e)
        {
            ...
            {
                T4SearchViewWizard.TemplateData.Columns.Find(r => r.ColumnName == item.ToString()).AddToGrid = true;
            }
            RefreshLists();
        }
