...
{
    public class ACSPropertyPagePropertyStore : IDisposable, IPropertyStore
    {
        private bool disposed = false;

        private List<ACSPropertyPageProjectFlavorCfg> configs = new List<ACSPropertyPageProjectFlavorCfg>();
        ...
        public void Initialize(object[] dataObjects)
        {
            ...
            foreach (object dataObject in dataObjects)
            {
                if (dataObject is IVsCfg)
                {
                    ...
                    var config = ACSPropertyPageProjectFlavorCfg.GetACSPropertyPageProjectFlavorCfgFromIVsCfg((IVsCfg)dataObject);
        ...
        public void Persist(string propertyName, string propertyValue)
        {
            ...
            foreach (ACSPropertyPageProjectFlavorCfg config in configs)
            {
                // Set the property
