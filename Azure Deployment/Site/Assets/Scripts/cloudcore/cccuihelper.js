...
function initialiseDisableSubmit(applicationRootPath) {
    ...
    var submitButton = $('input[type="submit"').not(".excludegif");
    var waitButton = $('button[type="submit"').not(".excludegif");
    var loginButton = $('.loginbutton');

    submitButton.removeAttr('disabled');
    waitButton.removeAttr('disabled');
    ...
    submitButton.on('click', function () {
        ...
        $(this).parent().addClass('submit-btn-loader');
...
function enableSubmit(selector) {
    ...
    setTimeout(function() {
        ...
        el.removeClass('submit-btn-loader');
        el.removeClass('wait-btn-loader');
    }, 500);        
}
